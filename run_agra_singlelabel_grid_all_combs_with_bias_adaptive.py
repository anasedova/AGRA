...
from src.single_label.gradient_matching_single_label_with_bias_adaptive import train_grad_match_with_gold
...
if __name__ == '__main__':
    ...
    output_path = os.path.join(file_path, 'results_with_bias_adaptive')
