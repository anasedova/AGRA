...
from wrench.evaluation import metric_to_direction
...
def grid_search(model: BaseModel,
    ...
    if parallel:
        ...
        study.optimize(parallel_objective, n_jobs=n_jobs, catch=(Exception,), callbacks=callbacks, timeout=study_timeout)
        ...
        study.optimize(objective, n_jobs=n_jobs, catch=(Exception,), callbacks=callbacks, timeout=study_timeout)
