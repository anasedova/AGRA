...
if __name__ == '__main__':
    ...
    encoding = "efficientnetb0"  # tf-idf, resnet50 or efficientnet-b0
    ...
    if args.seed is not None:
        ...
        results_folder = os.path.join(args.output_path, "results_reproduce", 'agra', args.dataset, f"trl_{'CE'}_cml_{args.closs}")
