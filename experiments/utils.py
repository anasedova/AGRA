...
def define_eval_metric(dataset: str):
    """
...
def get_cifar_data(dataset_path: str, num_valid_samples: int, transformation="standard"):
    """
...
def load_train_labels_from_file(dataset_path: str, train_labels_path: str, dataset:str):
    """
