...
from src.single_label.gradient_matching_single_label_no_bias_adaptive import train_grad_match_with_gold
...
class AGRAExperiments:
    ...
    def __init__(
        ...
        self.storing_loc = os.path.join(
            output_data_path, self.dataset, f"trl_{self.train_loss}_cml_{self.comp_loss}_weights_{(self.use_weights)}"
        )
            ...
            for learning_rate in learning_rates:
                for batch_size in batch_sizes:
                    for decay in weight_decay:
                        ...
                        combs.append((learning_rate, batch_size, decay, threshold))
                        logger.info("========================================")
                        logger.info(f"Current combination: {(learning_rate, batch_size, decay, threshold)}")
                        logger.info("========================================")
...
if __name__ == '__main__':
    ...
    output_path = os.path.join(file_path, 'results_no_bias_adaptive')
    ...
    if args.dataset is None:
        ...
        for dataset in datasets:
            ...
            if args.train_loss is None and args.comp_loss is None and args.weights is None:
